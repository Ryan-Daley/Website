    ...
    create(context) {
        ...
        const markPropsOnCondition = (node, cb) => {
            ...
            if (node.params.length === 1 &&
                ...
                ((_b = node.parent) === null || _b === void 0 ? void 0 : _b.type) !== "TemplateLiteral" &&
                cb(node.params[0])) {
        ...
        const handleTrackedScopes = (identifier, declarationScope) => {
            ...
            if (!currentScope().trackedScopes.find((trackedScope) => matchTrackedScope(trackedScope, identifier))) {
                const matchedExpression = currentScope().trackedScopes.find((trackedScope) => matchTrackedScope(Object.assign(Object.assign({}, trackedScope), { expect: "expression" }), identifier));
                if (declarationScope === currentScopeNode) {
                    ...
                    const pushUnnamedDerivedSignal = () => { var _a; var _b; return ((_a = (_b = parentScope()).unnamedDerivedSignals) !== null && _a !== void 0 ? _a : (_b.unnamedDerivedSignals = new Set())).add(currentScopeNode); };
                    ...
                    else if (((_k = currentScopeNode.parent) === null || _k === void 0 ? void 0 : _k.type) === "Property") {
                    }
                    else {
                        pushUnnamedDerivedSignal();
                    }
        ...
        const onFunctionExit = (currentScopeNode) => {
            ...
            if ((0, utils_2.isFunctionNode)(currentScopeNode)) {
                markPropsOnCondition(currentScopeNode, (props) => {
                    var _a, _b;
                    return !(0, utils_2.isPropsByName)(props.name) &&
                        currentScope().hasJSX &&
                        (currentScopeNode.type !== "FunctionDeclaration" ||
                            !((_b = (_a = currentScopeNode.id) === null || _a === void 0 ? void 0 : _a.name) === null || _b === void 0 ? void 0 : _b.match(/^[a-z]/)));
                });
            }
            ...
            for (const { reference, declarationScope } of scopeStack.consumeSignalReferencesInScope()) {
                ...
                if (reference.isWrite()) {
                    ...
                    if (((_a = identifier.parent) === null || _a === void 0 ? void 0 : _a.type) === "CallExpression" ||
                        (((_b = identifier.parent) === null || _b === void 0 ? void 0 : _b.type) === "ArrayExpression" &&
                            ((_c = identifier.parent.parent) === null || _c === void 0 ? void 0 : _c.type) === "CallExpression")) {
                        handleTrackedScopes(identifier, declarationScope);
                    }
                    else if (((_d = identifier.parent) === null || _d === void 0 ? void 0 : _d.type) === "TemplateLiteral") {
                        reportBadSignal("template literals");
                    }
                    else if (((_e = identifier.parent) === null || _e === void 0 ? void 0 : _e.type) === "BinaryExpression" &&
                        [
                            "<",
                            "<=",
                            ">",
                    ...
                    else if (((_f = identifier.parent) === null || _f === void 0 ? void 0 : _f.type) === "UnaryExpression" &&
                        ["-", "+", "~"].includes(identifier.parent.operator)) {
                    ...
                    else if (((_h = identifier.parent) === null || _h === void 0 ? void 0 : _h.type) === "JSXExpressionContainer" &&
                        ...
                        if ((elementOrAttribute === null || elementOrAttribute === void 0 ? void 0 : elementOrAttribute.type) === "JSXElement" ||
                            ((elementOrAttribute === null || elementOrAttribute === void 0 ? void 0 : elementOrAttribute.type) === "JSXAttribute" &&
                                ((_j = elementOrAttribute.parent) === null || _j === void 0 ? void 0 : _j.type) === "JSXOpeningElement" &&
            ...
            for (const { reference, declarationScope } of scopeStack.consumePropsReferencesInScope()) {
                ...
                else if (((_k = identifier.parent) === null || _k === void 0 ? void 0 : _k.type) === "MemberExpression" &&
                    identifier.parent.object === identifier) {
                    const { parent } = identifier;
                    if (((_l = parent.parent) === null || _l === void 0 ? void 0 : _l.type) === "AssignmentExpression" && parent.parent.left === parent) {
                        context.report({
                            node: identifier,
                            messageId: "noWrite",
                            data: {
                ...
                else if (((_m = identifier.parent) === null || _m === void 0 ? void 0 : _m.type) === "AssignmentExpression" ||
                    ((_o = identifier.parent) === null || _o === void 0 ? void 0 : _o.type) === "VariableDeclarator") {
                    context.report({
                        node: identifier,
        ...
        const checkForTrackedScopes = (node) => {
            ...
            if (node.type === "JSXExpressionContainer") {
                if (((_a = node.parent) === null || _a === void 0 ? void 0 : _a.type) === "JSXAttribute" &&
                    /^on[:A-Z]/.test(sourceCode.getText(node.parent.name)) &&
                    ((_b = node.parent.parent) === null || _b === void 0 ? void 0 : _b.type) === "JSXOpeningElement" &&
                    node.parent.parent.name.type === "JSXIdentifier" &&
                    (0, utils_2.isDOMElementName)(node.parent.parent.name.name)) {
                    pushTrackedScope(node.expression, "called-function");
                }
                else if (((_c = node.parent) === null || _c === void 0 ? void 0 : _c.type) === "JSXAttribute" &&
                    node.parent.name.name === "value" &&
                    ((_d = node.parent.parent) === null || _d === void 0 ? void 0 : _d.type) === "JSXOpeningElement" &&
                    ((node.parent.parent.name.type === "JSXIdentifier" &&
                ...
                else if (((_e = node.parent) === null || _e === void 0 ? void 0 : _e.type) === "JSXAttribute" &&
                    ((_f = node.parent.name) === null || _f === void 0 ? void 0 : _f.type) === "JSXIdentifier" &&
                    /^static[A-Z]/.test(node.parent.name.name) &&
                    ((_g = node.parent.parent) === null || _g === void 0 ? void 0 : _g.type) === "JSXOpeningElement" &&
                    node.parent.parent.name.type === "JSXIdentifier" &&
                    !(0, utils_2.isDOMElementName)(node.parent.parent.name.name)) {
                }
                else if (((_h = node.parent) === null || _h === void 0 ? void 0 : _h.type) === "JSXAttribute" &&
                    node.parent.name.name === "ref" &&
                    (0, utils_2.isFunctionNode)(node.expression)) {
                    pushTrackedScope(node.expression, "called-function");
                }
                else if (((_j = node.parent) === null || _j === void 0 ? void 0 : _j.type) === "JSXElement" && (0, utils_2.isFunctionNode)(node.expression)) {
                        ...
                        if (arg1) {
                            ...
                            if (owner) {
                                ...
                                if (decl &&
                                    ...
                                    ((_k = decl.node.init) === null || _k === void 0 ? void 0 : _k.type) === "CallExpression" &&
                ...
                if (((_l = node.init) === null || _l === void 0 ? void 0 : _l.type) === "CallExpression" && node.init.callee.type === "Identifier") {
                        ...
                        if (track) {
                            for (const reference of track.references) {
                                if (!reference.init &&
                                    ...
                                    ((_m = reference.identifier.parent) === null || _m === void 0 ? void 0 : _m.type) === "CallExpression" &&
        ...
        return {
            ...
            CallExpression(node) {
                ...
                if ((parent === null || parent === void 0 ? void 0 : parent.type) !== "AssignmentExpression" && (parent === null || parent === void 0 ? void 0 : parent.type) !== "VariableDeclarator") {

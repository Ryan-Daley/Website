...
// node_modules/.pnpm/@solidjs-use+solid-to-vue@1.2.0/node_modules/@solidjs-use/solid-to-vue/dist/index.mjs
...
// node_modules/.pnpm/@solidjs-use+shared@1.2.0/node_modules/@solidjs-use/shared/dist/index.mjs
var _a;
...
// node_modules/.pnpm/solidjs-use@1.2.0/node_modules/solidjs-use/dist/index.mjs
...
function createAsyncMemo(evaluationCallback, initialState, optionsOrSetter) {
  let options;
  if (isFunction2(optionsOrSetter)) {
    options = {
...
function onLongPress(target, handler, options) {
  ...
  function onDown(ev) {
    var _a22, _b2, _c;
    if (((_a22 = options == null ? void 0 : options.modifiers) == null ? void 0 : _a22.self) && ev.target !== elementRef())
      return;
    clear();
...
function useBluetooth(options) {
  ...
  const isConnected = createMemo(() => {
    var _a2;
    return ((_a2 = server()) == null ? void 0 : _a2.connected) ?? false;
  });
  ...
  tryOnMount(() => {
    ...
    const deviceVal = device();
    if (deviceVal)
      (_a2 = deviceVal.gatt) == null ? void 0 : _a2.connect();
  });
  tryOnCleanup(() => {
    var _a2;
    const deviceVal = device();
    if (deviceVal)
      (_a2 = deviceVal.gatt) == null ? void 0 : _a2.disconnect();
  });
  return {
    isSupported,
    isConnected,
...
function useClipboard(options = {}) {
  ...
  function legacyRead() {
    var _a2, _b;
    return ((_b = (_a2 = document == null ? void 0 : document.getSelection) == null ? void 0 : _a2.call(document)) == null ? void 0 : _b.toString()) ?? "";
  }
  return {
    isSupported,
    text,
...
function useCssVar(prop, target, { window: window2 = defaultWindow, initialValue = "" } = {}) {
  ...
  const elAccessor = createMemo(() => {
    var _a2;
    return unAccessor(target) ?? ((_a2 = window2 == null ? void 0 : window2.document) == null ? void 0 : _a2.documentElement);
  });
  createEffect(
  ...
  createEffect(
    on(
      ...
      (val) => {
        var _a2, _b;
        if ((_a2 = elAccessor()) == null ? void 0 : _a2.style) {
...
function defaultDump(clone) {
  return clone ? isFunction2(clone) ? clone : cloneFnJSON : fnBypass;
}
...
function useDevicesList(options = {}) {
  ...
  const isSupported = useSupported(() => {
    var _a2;
    return (_a2 = navigator == null ? void 0 : navigator.mediaDevices) == null ? void 0 : _a2.enumerateDevices;
  });
...
function useDisplayMedia(options = {}) {
  ...
  async function _stop() {
    var _a2;
    (_a2 = stream()) == null ? void 0 : _a2.getTracks().forEach((t) => t.stop());
    setStream(void 0);
  }
  function stop() {
    _stop();
...
function useElementSize(target, initialSize = { width: 0, height: 0 }, options = {}) {
  ...
  const isSVG = createMemo(() => {
    var _a2, _b;
    return (_b = (_a2 = unAccessor(target)) == null ? void 0 : _a2.namespaceURI) == null ? void 0 : _b.includes("svg");
  });
    ...
    return new Promise((resolve, reject) => {
      ...
      fetch(context.url, {
        ...
        headers: {
          ...
          ...headersToObject((_a2 = context.options) == null ? void 0 : _a2.headers)
        }
...
function useFileSystemAccess(options = {}) {
  ...
  const fileName = createMemo(() => {
    var _a2;
    return ((_a2 = file()) == null ? void 0 : _a2.name) ?? "";
  });
  const fileMIME = createMemo(() => {
    var _a2;
    return ((_a2 = file()) == null ? void 0 : _a2.type) ?? "";
  });
  const fileSize = createMemo(() => {
    var _a2;
    return ((_a2 = file()) == null ? void 0 : _a2.size) ?? 0;
  });
  const fileLastModified = createMemo(() => {
    var _a2;
    return ((_a2 = file()) == null ? void 0 : _a2.lastModified) ?? 0;
  });
  ...
  async function updateFile() {
    var _a2;
    const f = await ((_a2 = fileHandle()) == null ? void 0 : _a2.getFile());
    setFile(() => f);
  }
  async function updateData() {
    var _a2, _b;
    if (unAccessor(dataType) === "Text")
      setData(await ((_a2 = file()) == null ? void 0 : _a2.text()));
  ...
  const [focused, setFocused] = writableComputed({
    ...
    set(value) {
      ...
      if (!value && innerFocused())
        (_a2 = targetElement()) == null ? void 0 : _a2.blur();
      if (value && !innerFocused())
...
function useScroll(element, options = {}) {
  ...
  function scrollTo(_x, _y) {
    ...
    if (!_element)
      return;
    (_a2 = _element instanceof Document ? document.body : _element) == null ? void 0 : _a2.scrollTo({
      top: unAccessor(_y) ?? y(),
...
function usePointerSwipe(target, options = {}) {
  ...
  const eventIsAllowed = (e) => {
    ...
    return ((_a2 = options.pointerTypes) == null ? void 0 : _a2.includes(e.pointerType)) ?? (isReleasingButton || isPrimaryButton) ?? true;
  };
  const stops = [
    useEventListener(target, "pointerdown", (e) => {
      ...
      (_b = (_a2 = targetRef()) == null ? void 0 : _a2.style) == null ? void 0 : _b.setProperty("touch-action", "none");
    ...
    useEventListener(target, "pointerup", (e) => {
      ...
      setIsSwiping(false);
      (_b = (_a2 = targetRef()) == null ? void 0 : _a2.style) == null ? void 0 : _b.setProperty("touch-action", "initial");
    })
  ];
  const stop = () => stops.forEach((s) => s());
  return {
...
function useTextDirection(options = {}) {
  ...
  function getValue2() {
    var _a2;
    return ((_a2 = document2 == null ? void 0 : document2.querySelector(selector)) == null ? void 0 : _a2.getAttribute("dir")) ?? initialValue;
  }
  ...
  return {
    ...
    setDir: (v) => {
      ...
      if (!document2)
        return;
      if (dir())
        (_a2 = document2.querySelector(selector)) == null ? void 0 : _a2.setAttribute("dir", dir());
      else
...
function useTextSelection(options = {}) {
  ...
  const text = createMemo(() => {
    var _a2;
    return ((_a2 = selection()) == null ? void 0 : _a2.toString()) ?? "";
  });
...
function useTextareaAutoSize(options) {
  ...
  function triggerResize() {
    ...
    textareaRef().style.height = `${(_a2 = textareaRef()) == null ? void 0 : _a2.scrollHeight}px`;
...
function useTimeAgo(time, options = {}) {
  ...
  const timeAgo = createMemo(() => formatTimeAgo(new Date(unAccessor(time)), options, unAccessor(now2())));
  if (exposeControls) {
    return {
      timeAgo,
      ...controls
...
function useTitle(newTitle = null, options = {}) {
  ...
  function format(t) {
    ...
    return isFunction2(template) ? template(t) : unAccessor(template).replace(/%s/g, t);
  }
  createEffect(
    on(title[0], (t, o) => {
      if (t !== o && document2)
  ...
  if (options.observe && !options.titleTemplate && document2 && !isReadonly) {
    useMutationObserver(
      (_a2 = document2.head) == null ? void 0 : _a2.querySelector("title"),
      () => {
...
var useWebWorkerFn = (fn, options = {}) => {
  ...
  const callWorker = (...fnArgs) => new Promise((resolve, reject) => {
    ...
    (_a2 = worker()) == null ? void 0 : _a2.postMessage([[...fnArgs]]);
